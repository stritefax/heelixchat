...
type TrelloIconProps= {
  width?: number;
  height?: number;
};
export const TrelloIcon: FC<TrelloIconProps> = ({
  width = 20,
  height = 20,
}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="0 0 73.323 64" height={height}>
        <defs>
        ...
        <path
            ...
            fill="url(#A)" fillRule="evenodd" transform="matrix(1.163111 0 0 1.163111 .023263 -6.417545)"/>
    </svg>
);
